...
void plotterAndTemplateMakerLIN(int year = 2018, int useMCatNLO = 1, int enriched = 0){
	...
	for (int it=0; it < 5; it++) {
	  ...
	  if (it==2) sprintf(filename,"template/root_output_files/lin_vbs_Moriond_%d%s.root",year,theExtra.c_str()); 
