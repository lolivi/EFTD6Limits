...
int main( int argc, char *argv[] )
{
   ...
   TString file_name_FR = "/afs/cern.ch/work/c/cthorbur/VBF_ANALYSIS/CMSSW_8_0_24_patch1/src/AnalysisStep/data/FakeRates/FakeRate_SS_Moriond368.root";
...
//   TString FakeRates   = path + "FakeRates" + file_name_FR;
   ...
   Plotter *plotter = new Plotter( 3.785 ); //35.86706
...
//=============================
   ...
   gROOT->ProcessLine("setTDRStyle();"); // Needed to reset margins set by 2D histograms
